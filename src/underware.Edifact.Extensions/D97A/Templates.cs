...
namespace underware.Edifact.D97A
{
    public static class Templates
    {
        ...
        public static GIR GIR(string qualf, string identityNo, string identityNoQualf, string identityNo2, string identityNoQualf2)
        {
            return new GIR()
            {
                E7297 = qualf,
