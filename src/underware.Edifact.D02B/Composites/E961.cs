...
public string E8216 { get; set; }
		[ElementInfo(2, "Journey leg duration quantity", "C", "", "an..6", "" )]
...
public string E2160 { get; set; }
		[ElementInfo(5, "Date or time or period text", "C", "", "an..35", "" )]
...
public string E3225 { get; set; }
		[ElementInfo(8, "Location name code", "C", "", "an..35", "" )]
public string E3225_0 { get; set; }
		[ElementInfo(9, "Location name code", "C", "", "an..35", "" )]
