...
namespace underware.Edifact.D00A.Composites
{
    public class C243
    {
				[ElementInfo(0, "Duty or tax or fee rate description code", "C", "", "an..7", "" )]
public string E5279 { get; set; }
		[ElementInfo(1, "Code list identification code", "C", "", "an..3", "" )]
public string E1131 { get; set; }
		[ElementInfo(2, "Code list responsible agency code", "C", "", "an..3", "" )]
public string E3055 { get; set; }
		[ElementInfo(3, "Duty or tax or fee rate description", "C", "", "an..17", "" )]
public string E5278 { get; set; }
		[ElementInfo(4, "Duty or tax or fee rate basis code", "C", "", "an..12", "" )]
