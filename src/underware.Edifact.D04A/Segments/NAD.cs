...
namespace underware.Edifact.D04A.Segments
{
    public class NAD : Segment
    {
        ...
        public string Qualifier { get => E3035; }
        public string Id { get => C082.E3039; }
        public string Agency { get => C082.E3055; }
        public string PartyName { get => C080.AllText; }
        public string Street { get => C059.AllText; }
        public string City { get => E3164; }
        public string ZIP { get => E3251; }
        public string Country { get => E3207; }
    }
}