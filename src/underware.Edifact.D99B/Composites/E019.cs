...
public string E3036 { get; set; }
		[ElementInfo(1, "Yes no code", "C", "", "an..3", "" )]
public string E9607 { get; set; }
		[ElementInfo(2, "Reference identifier", "C", "", "an..35", "" )]
...
public string E4440_0 { get; set; }
		[ElementInfo(5, "Free text value", "C", "", "an..512", "" )]
public string E4440_1 { get; set; }
		[ElementInfo(6, "Free text value", "C", "", "an..512", "" )]
